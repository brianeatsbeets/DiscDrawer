//
//  UIPickerController+CropFix.swift
//  DiscDrawer
//
...
// This extension of UIImagePickerController fixes a bug that does not allow panning while editing/cropping a taken photo
